...
//        LOG(error) << "Invalid shift value";
        throw std::runtime_error("<E> Invalid shift value");
    }
...
//        LOG(error) << "Could not map device memory region";
        throw std::runtime_error("<E> Could not map device memory region");
    }
